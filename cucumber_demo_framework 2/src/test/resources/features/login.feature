...
Feature: Login feature
  ...
  Scenario Outline: Verify Invalid Login for multiple users
   ...
   Scenario: Verify signup btton
     ...
     @login-5
     Scenario Outline: Verify error message for multiple users
       When I enter Irina into firstname text fields on home screen
       And I enter Khafizova into lastname text fields on home screen
