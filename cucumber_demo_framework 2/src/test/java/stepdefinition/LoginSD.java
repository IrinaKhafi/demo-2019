...
public class LoginSD {
    ...
    @When("^I enter (.+) into (username|password|firstname|lastname|mobile number|new password|email) text fields on home screen$")
    public void enterDataIntoTextFields(String value, String textFields) {
        ...
        switch (textFields) {
            ...
            case "new password":
                ...
                break;
            case "email":
                homePage.enterSignUpEmail(value);
                break;
        }
    }
    ...
    public void verifyInvalidEmailMessage(){
        homePage.clickOnPasswordField();
        homePage.clickOnRedButton();
        Assert.assertEquals(homePage.getInvalidEmailMessage(), "Please enter a valid mobile number or email address.");}
